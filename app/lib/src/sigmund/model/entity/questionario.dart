...
final questionario = [{
    ...
    "pergunta": "Eu gosto de", //2
    "respostas": ['Explorar novas rotas',
      'Conversar com os passageiros',
      'Planejar a viagem',
      'Ser piloto'],
  }, {
    "pergunta": "Se você quiser se dar bem comigo", //3
    ...
    "pergunta": "Minha preocupação é", //7
    ...
    "pergunta": "Eu gosto de", //9
    "respostas": ['Construir memórias ',
      'Tornar as pessoas confortáveis ',
      'Fazer sentido ',
      'Fazer progresso '],
  }, {
    "pergunta": "Eu gosto de chegar", //10
    "respostas": ['Em outro lugar ',
      'Junto',
      'Na hora',
      'Na frente'],
  }, {
    "pergunta": "Um ótimo dia para mim é quando", //11
    ...
    "pergunta": "Eu vejo a morte como", //12
    ...
    "pergunta": " Minha filosofia de vida é", //13
    ...
    "pergunta": "Eu sempre gostei de", //14
    "respostas": ['Explorar ',
    ...
    , {
      "pergunta": "Não existe nada de errado em", //16
    ...
    , {
      "pergunta": "Eu gosto de buscar conselhos de", //17
    ...
    , {
      "pergunta": "Se eu fosse bilionário", //21
    ...
    , {
      "pergunta": "Eu acredito também que", //23
    ...
    , {
      "pergunta": "Eu acredito ainda que", //24
